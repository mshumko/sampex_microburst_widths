...
As for the trends in AE, the median microburst duration decreases from 130 ms, for $AE < 100$ nT, to 95 ms for $AE > 300$ nT. This is in contrast to the trend quantified by \citeA{Teng2017}: the rising tone element duration distribution is broad and peaks at $\approx 500$ ms when $AE < 100$ nT; it then narrows and shifts to $\approx 250$ ms for $AE > 300$ nT. While both trend to shorter durations with increased AE, the scaling is different.
