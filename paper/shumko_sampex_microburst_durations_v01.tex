...
Lastly, we investigated microburst duration as a function of L and MLT in Figs. \ref{fig3} and \ref{fig4}. Figure \ref{fig3}a-c show the 25th, 50th, and 75th percentiles of the joint microburst duration distribution as a function of L and MLT. The sparse bins with less than 100 well-fit microbursts are white. For reference, Fig. \ref{fig3}d shows the total number of well-fit microbursts observed as a function of L and MLT.
