...
We assumed a fit model consisting of a Gaussian superposed with a straight line. The Gaussian models the shape of the microburst; while the linear trend accounts for the background electrons that are either trapped or quasi-trapped in the drift loss cone. The fit model is defined as:
\begin{equation}
