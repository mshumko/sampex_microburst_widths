...
In this study we used the $>1$ MeV electron count data, taken by the Heavy Ion Large Telescope (HILT) instrument CITE HERE, that was onboard the Solar Anomalous Magnetospheric Particle Explorer (SAMPEX) satellite CITE HERE. 

The SAMPEX satellite was launched on X and reentered the atmosphere on Y CITE HERE. It was in a 520x670 km, $82^\circ$ inclination orbit. Broadly, the SAMPEX had two pointing modes: spin mode and zenith pointing modes. To avoid the compounding effects due to the variable pitch angles sampled in the spin mode, we focused this study on the zenith pointing data.
