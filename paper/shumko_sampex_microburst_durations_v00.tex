...
\end{equation} where $SS_{res}$ is the sum of squares of the residuals between the observed counts $c_i$ and the fit counts $f_i$ for each time stamp, and $SS_{mean}$ is the sum of squares between $c_i$ and the mean counts $\bar{c}$.
